    ...
    <div class="layui-row">
        ...
        <div class="layui-col-xs12 layui-col-sm12 layui-col-md8">
            <form class="layui-form layui-form-pane"
                  ...
                  method="post">
                <input type="text" name="roleId" lay-verify="required" placeholder="角色id"
                       value="${role.roleId}" hidden>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <c:forEach items="${permission.childMenu}" var="permission">
                            <c:if test="${fn:contains(permissions, permission.name)}">
                                <input type="checkbox" name="permission" lay-filter="permission" checked
                                       value="${permission.id}"
                            ...
                            <c:forEach items="${permission.childMenu}" var="permission">
                                <c:if test="${fn:contains(permissions, permission.name)}">
                                    <br><input type="checkbox" name="permission" lay-filter="permission" checked
                                               value="${permission.id}"
                                               lay-skin="primary" title="${permission.name}">
                                </c:if>
                                <c:if test="${!fn:contains(permissions, permission.name)}">
