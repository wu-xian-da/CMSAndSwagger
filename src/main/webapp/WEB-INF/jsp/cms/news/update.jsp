    ...
    <div class="layui-row">
        ...
        <div class="layui-col-xs12 layui-col-sm12 layui-col-md8">
            <form class="layui-form layui-form-pane"
                  action="${pageContext.request.contextPath}/admin/news/update/"
                  method="post">
                <div class="layui-form-item">
                    <label class="layui-form-label">文章标题</label>
                    <div class="layui-input-block">
                        <input type="text" class="layui-input" <shiro:hasAnyRoles name="user">readonly</shiro:hasAnyRoles> name="title" value="${news.title}" lay-verify="required" placeholder="请输入文章标题">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" style="z-index: 1000">
                            <select name="officeId" <shiro:hasAnyRoles name="user">disabled</shiro:hasAnyRoles> lay-filter="officeId">
                                <c:forEach items="${offices}" var="office">
                                    <c:if test="${news.officeId==office.id}">
                ...
                <div class="layui-form-item">
                    ...
                    <input hidden="hidden" id="id" name="id" value="${news.id}">
                    <div class="layui-input-block">
