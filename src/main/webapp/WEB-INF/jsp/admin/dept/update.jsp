    ...
    <div class="layui-row">
        <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
            <div class="x-nav layui-elem-quote">
             ...
             <a><cite><i class="layui-icon" style="line-height:25px">&#xe68e  </i>首页</cite></a>
                <a href="${pageContext.request.contextPath}/admin/dept/index">部门列表</a>
                <a><cite>修改部门</cite></a>
            </span>
        ...
        <div class="layui-col-xs12 layui-col-sm8 layui-col-md6">
            <form class="layui-form layui-form-pane"
                  action="${pageContext.request.contextPath}/admin/dept/update/"
                  method="post">
                <div class="layui-form-item">
                    <label class="layui-form-label">部门名称</label>
                    <div class="layui-input-block">
                        <input type="hidden" name="id" lay-verify="required" placeholder="id"
                               value="${dept.id}"
                               class="layui-input">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="code" lay-verify="required" placeholder="请输入部门代码"
                               value="${dept.code}"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="parantid" lay-search="">
                            <option value="">请输入或选择父级部门</option>
                            <c:forEach items="${depts}" var="dept1">
                                <c:if test="${dept.parantid==dept1.id}">
                                    <option value="${dept1.id}" selected>${dept1.name}</option>
                                </c:if>
                                <c:if test="${dept.parantid!=dept1.id}">
