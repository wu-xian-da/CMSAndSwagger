...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl">
            <a class="logo navbar-logo f-l mr-10 hidden-xs" href="javascript:;">yutonsCMS内容管理系统！</a>
            <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="javascript:;">yutonsCMS内容管理系统</a>
    ...
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active">
                    <span title="我的桌面" data-href="${pageContext.request.contextPath}/admin/index/welcome">我的桌面</span>
                    <em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe name="ifr_body" scrolling="yes" frameborder="0"
                    src="${pageContext.request.contextPath}/admin/index/welcome"></iframe>
        </div>
    </div>
</section>
